    ...
    private class ReactivePacketProcessor implements PacketProcessor {
        ...
        public void process(PacketContext context) {
            ...
            if (ethPkt.getEtherType() == Ethernet.TYPE_IPV4) {
                ...
                DeviceId sourceAccessSwitch = hostService.getHost(srcId).location().deviceId();
                PortNumber sourceAccessSwitchPort = hostService.getHost(srcId).location().port();
                ...
                captivePortalUserInfo = new CaptivePortalUserInfo(
                    ...
                    protocol,
                    sourceAccessSwitch.toString(), sourceAccessSwitchPort.toString(),
